import { defineComponent, computed, ref, mergeProps, useSSRContext } from 'file://D:/workshop/FullStack/toptech_shop/node_modules/vue/index.mjs';
...
import { useRoute } from 'file://D:/workshop/FullStack/toptech_shop/node_modules/vue-router/vue-router.node.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center text-gray-500 py-10 text-lg"> ยังไม่มีสินค้าในแบรนด์นี้ </div>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/brand/[brand].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_brand_-DXlagrGI.mjs.map
