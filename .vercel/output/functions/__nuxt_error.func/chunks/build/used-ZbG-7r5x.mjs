  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div class="text-center text-gray-500 py-10 text-lg"> ไม่มีสินค้าประเภท “มือ 2” </div>`);
      } else {
        _push(`<!---->`);
      }
      if (loading.value) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product/condition/used.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=used-ZbG-7r5x.mjs.map
